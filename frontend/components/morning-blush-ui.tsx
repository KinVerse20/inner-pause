...
export function BlushCard({
  ...
  return (
    <section className={`rounded-[1.65rem] border border-white/70 bg-white/68 shadow-[0_18px_46px_rgba(152,117,139,0.14)] backdrop-blur-2xl ${className}`}>
      {children}
    </section>
  );
}
...
export function ChakraStonePath({
  ...
  return (
    <div className="relative mx-auto flex min-h-[21rem] w-full max-w-[16rem] flex-col items-center justify-center py-5">
  ...
  return (
    <div className="relative mx-auto grid h-52 w-52 place-items-center">
      ...
      <div className="relative text-center">
        <p className="font-serif text-5xl text-[#322d42]">{clamped}%</p>
...
export function BlushChoicePanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end bg-[#322d42]/24 px-3 pb-3 backdrop-blur-[3px] sm:items-center sm:justify-center">
      ...
      <section className="relative z-10 w-full max-w-md rounded-[1.8rem] border border-white/70 bg-[#fffaf6]/92 p-4 shadow-[0_24px_70px_rgba(50,45,66,0.18)] backdrop-blur-2xl">
